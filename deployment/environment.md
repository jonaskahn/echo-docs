  ...
  "containerDefinitions": [
    {
      ...
      "image": "echo:latest",
      "environment": [
        { "name": "ECHO_APP_NAME", "value": "Echo Multi-agents AI Framework" },
        { "name": "ECHO_DEBUG", "value": "false" },
        { "name": "ECHO_DEFAULT_LLM_PROVIDER", "value": "openai" },
        { "name": "ECHO_CONVERSATION_STORAGE_BACKEND", "value": "postgresql" },
        { "name": "ECHO_PERSISTENCE_TYPE", "value": "checkpoint" },
        { "name": "ECHO_PERSISTENCE_CHECKPOINT_LAYER", "value": "redis" }
      ],
      "secrets": [
        {
...
# 4. Start Echo: poetry run python -m echo
```
